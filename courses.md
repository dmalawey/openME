...
- ![mech mat textbook image](img/course_mechmat1.jpg)
...
* [ME231 Fluids Binder](https://raw.githubusercontent.com/dmalawey/openME/main/docs/ME231_fluidsBinder.pdf) with syllabus, solved problems, exams & admin info
* [ME231 Fluids Notes](https://github.com/dmalawey/openME/blob/1c49f194f3277d092546f93ded9dad98e6f2bbc4/docs/ME231_fluidsNotes.pdf) with the semester's lecture notes
* [ME231 Textbook Solutions](https://github.com/dmalawey/openME/blob/f75697a3f3663b3bd41c49fd4b15ffe4c02fa6c7/docs/ME231_SolutionsGuide.pdf) for Fluid Mechanics 7th Edition by Frank White
...
This course is a paired course of EMGT124 AND EMGT137 called **Economic Analysis of Engineering Projects**.  The EMGT courses reside in the department of Engineering Management which offers a whole degree program for those who struggle sophomore year in real engineering programs (hehe that's a common joke) EMGT is a whole separate department in the university from Mechanical Engineering.  The purpose of this course in the ME degree is intended to introduce the concepts of Engineering Project Management with an overview of the financial planning that drive real-world engineering projects.  This course requires applies mathematics in every chapter, but it tends to be lower-level math.  One exciting thing I learned is that MS Excel has many built-in computations for management work like the calculation of loan payments and net-present-value and depreciation of equipment.  This knowledge serves to satisfy the financial, accounting, and legal requirements of an engineering project and to allow engineers to speak the language of accounting just enough that we won't be oblivious.  It's a very important course if you wish to become an entrepreneur or join a consulting team as the budgeting of cashflows and exchange of resources between businenesses will require this knowledge.
...
_Below, find the textbook cover for the text we used, an example of the formulas for Valuation of assets, and an example of a Spider Plot formed from an economic sensitivity analysis from a later chapter._
- ![img eng management textbook cover](img/course_EMGT1.jpg)
- ![img eng management formulas](img/course_EMGT2.jpg)
- ![img eng management sensitivity plot](img/course_EMGT3.jpg)
